...
- Invitations already identify a group and phone number and registration already
  consumes unexpired invitations for a new account.
...
5. Make an invitation immediately associate an existing account, while preserving
   registration-time association for a person who has not registered yet.
